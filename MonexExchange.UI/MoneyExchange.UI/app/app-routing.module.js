...
var routes = [
    ...
    { path: 'home', component: home_component_1.HomeComponent, canActivate: [auth_guard_services_1.AuthGuardService] },
    { path: 'about', component: about_component_1.AboutComponent, canActivate: [auth_guard_services_1.AuthGuardService] },
